...
#include<string.h>
// Average load: 	 5041 
// Average operate: 	 3928 
// Average store: 	 7985 
// Average X1: 	 8796 


// Average load: 	 5022 
// Average operate: 	 4242 
// Average store: 	 7917 
// Average X1: 	 8812 

//Average load: 	 4956 
//Average operate: 	 3997 
//Average store: 	 8130 
//Average X1: 	 8936 
...
int main()
{
	...
	int i;
	for(i=0;i<10000;i++){
		test_pack_13bit(bytes0,data0);
		test_pack_13bit(bytes1,data1);
		test_pack_13bit(bytes2,data2);
		test_pack_13bit(bytes3,data3);
		test_pack_13bitX4(bytes0,bytes1,bytes2,bytes3,data0,data1,data2,data3);
	}
