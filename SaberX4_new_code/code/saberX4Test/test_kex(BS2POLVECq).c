...
void BS2VqX4(const unsigned char *bytes0, const unsigned char *bytes1, const unsigned char *bytes2, const unsigned char *bytes3, 
...
void BS2Vq(const unsigned char *bytes, uint16_t data[SABER_K][SABER_N]){
...
int test_BS2POLVEC(){
	...
	for(i=0; i<repeat; i++)
  	{
	    //CLOCK1=cpucycles();	
	    BS2VqX4(bs0, bs1, bs2, bs3, data0 ,data1, data2, data3);
	    BS2Vq(bs0, dataN0);
	    BS2Vq(bs1, dataN1);
	    BS2Vq(bs2, dataN2);
	    BS2Vq(bs3, dataN3);
